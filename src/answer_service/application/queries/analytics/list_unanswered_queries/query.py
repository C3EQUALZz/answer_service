...
class ListUnansweredQueriesQuery(Query[UnansweredQueriesResponse]):
    """Lists the queries that returned nothing, most frequent first.

    The actionable half of the statistics: each entry is a question users keep
    asking that the FAQ does not cover yet. Paginated because that list is a
    backlog someone works through, not a single screen.
    """
